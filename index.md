...
- **Access an example dataset**  
  ...
  demonstration. Use [`head()`](https://rdrr.io/r/utils/head.html) to
  view the first few rows and inspect the data structure.
...
- **Combine analysis with visualisation**  
  ...
  the package’s built-in plotting function
...
![graphTRH](reference/figures/README-graphTRH_DewPoint-1.png)

- **Conservator tools: mould growth estimation**  
  Calculate mould growth risk using
...
![mould](reference/figures/README-mould_risk-1.png)
...
- **Graphs: generate a psychrometric chart**  
  ...
  The example shows how a basic plot can be customised; data
...
![psych_chart](reference/figures/README-psychart-1.png)
