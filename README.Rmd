...
```{r graph the TRH data after adding dew point, message=FALSE, warning=FALSE, fig.alt="graphTRH"}
mydata |>
...
```{r use the mould risk function, message=FALSE, warning=FALSE, fig.alt="mould"}
mydata |>
