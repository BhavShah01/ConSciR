...
-   **Perform calculations on the data**\
    Use ConSciR functions to add environmental metrics such as dew point (**`calcDP`**), absolute humidity (**`calcAH`**), lifetime multiplier (**`calcLM`**), and preservation index (**`calcPI`**) to the dataset. More functions are available in the package 'Reference'.
...
-   **Humidity functions: generate a psychrometric chart**\
    Visualise the dataset in a psychrometric chart with **`graph_psychrometric()`**.
