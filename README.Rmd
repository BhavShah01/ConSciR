...
```{r graph the TRH data after adding dew point, message=FALSE, warning=FALSE, fig.alt="graph_TRH_data_dew_point"}
mydata |>
...
```{r use the mould risk function, message=FALSE, warning=FALSE, fig.alt="mould_risk_function"}
mydata |>
