...
ConSciR is an R package specifically designed to assist conservators, scientists and engineers by providing a toolkit for performing calculations and streamlining common tasks in cultural heritage conservation. ConSciR is designed for:
...
-   FAIR: ConSciR is designed to be findable, accessible, interoperatable and resuable. 
