...
ConSciR is an R package specifically designed to assist conservators and scientists by providing a toolkit for performing calculations and streamlining common tasks in conservation. 


## Tools available 


-   Calculations: humidity calculations, conservation tools (lifetime, mould, preservation index, etc)
...
```{r calculations to visualise the data, message=FALSE, warning=FALSE}
...
mydata |>
  ...
  labs(
    ...
    y = "",
    title = "Sensor",
    subtitle = "Temperature (red), relative humidity (blue), absolute humidity (green), dew point (purple)",
    caption = "ConSciR"
  ) +
  # Apply a theme
  theme_minimal()
