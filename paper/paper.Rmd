...
library(ConSciR); library(ggplot2)
mydata |>
...
We acknowledge contributions from Emily R. Long, Marcin Zygmunt, Hebe Halstead, Avery Bazemore, Josep Grau-Bové, Scott Allan Orr, Seka Seneviratne, Jenny Kim, Èlia Batlle, Rose King and David Thickett for the development of the `ConSciR` package.
